 ...
 * <?php echo $name; ?> Model
 *
 * Esta classe é responsável ​​pela gestão de quase tudo o que acontece a respeito do(a) <?php echo __($name)?>, 
...
if (!empty($validate)):
	...
	foreach ($validate as $field => $validations):
		...
		foreach ($validations as $key => $validator):
			...
			echo "\t\t\t\t'message' => 'O campo " . __(ucfirst($field)) . " deve ser preenchido corretamente.',\n";
			echo "\t\t\t),\n";
		endforeach;
		echo "\t\t),\n";
	endforeach;
